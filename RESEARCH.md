...
- Testing baseline: `tests/export-regression.test.js` now verifies ZIP central directory output, ICO headers, platform filenames, generated manifest/snippet support files, and replacement-template matching. Remaining tests should expand into UI-visible validation, dimensions, and preset-specific failure reporting.
